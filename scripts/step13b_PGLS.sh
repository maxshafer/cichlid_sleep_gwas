...
Rscript ../../scripts/PGLSrun.R speciesCodesAndGenomeIDs_for_GWAS_2_cohort_db_geno_${INTERVAL}_fromProbabilities_AF.txt ../../scripts/combined_diel_patterns_2022-04-26_dp_updated_names.csv peak_amplitude 
