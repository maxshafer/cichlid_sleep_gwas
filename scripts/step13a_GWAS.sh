...
Rscript ../../scripts/GWASrun.R speciesCodesAndGenomeIDs_for_GWAS_2_cohort_db_geno_${INTERVAL}_fromProbabilities_AF.txt ../../pheno_data/combined_cichlid_data_2022-11-17.csv peak 
