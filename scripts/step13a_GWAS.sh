...
Rscript /scicore/home/schiera/gizevo30/projects/cichlids_2/scripts/GWASrun.R speciesCodesAndGenomeIDs_for_GWAS_2_NMBU_cohort_genotyped_whole_${INTERVAL}_fromProbabilities_AF.txt /scicore/home/schiera/gizevo30/projects/cichlids_2/pheno_data/cichlid_pc-loadings_eco-morph_rest_full.csv ${TEST} 
