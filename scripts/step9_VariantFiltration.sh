...
#SBATCH --output=/home/ayasha/scratch/logs/VarFiltstdout.txt     #These are the STDOUT and STDERR files
#SBATCH --error=/home/ayasha/scratch/logs/VarFiltstderr.txt
