...
bcftools view -r $INTERVAL --threads 8 -O z -o NMBU_cohort_genotyped_whole_${INTERVAL}_HardFilter_BiAllelic_NoSingletons.g.vcf.gz ../NMBU_cohort_genotyped_whole_HardFilter_BiAllelic_NoSingletons.g.vcf.gz

~/gatk-4.2.4.0/gatk IndexFeatureFile -I NMBU_cohort_genotyped_whole_${INTERVAL}_HardFilter_BiAllelic_NoSingletons.g.vcf.gz
