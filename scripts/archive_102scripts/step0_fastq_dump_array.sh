...
fastq-dump --gzip  --outdir $TMPDIR --split-files /scicore/home/schiera/gizevo30/ncbi/public/sra/SRR96${SLURM_ARRAY_TASK_ID}.sra

cp $TMPDIR/SRR96${SLURM_ARRAY_TASK_ID}_1.fastq.gz /scicore/home/schiera/gizevo30/projects/cichlids_2/sra_reads_nobackup/SRR96${SLURM_ARRAY_TASK_ID}_1.fastq.gz
cp $TMPDIR/SRR96${SLURM_ARRAY_TASK_ID}_2.fastq.gz /scicore/home/schiera/gizevo30/projects/cichlids_2/sra_reads_nobackup/SRR96${SLURM_ARRAY_TASK_ID}_2.fastq.gz
